...
class TestFactoidTransaction(unittest.TestCase):
    ...
    test_data = "02016bb2d7cd7e0201008991b4e605c07d49124e6a6d968a25be00596939e7cb27af821a3119d60e55fd075ab1838e8d8b64" \
    ...
    def test_unmarshal(self):
        ...
        expected_inputs = [
            {
                "value": 2452435717,
                "fct_address": "c07d49124e6a6d968a25be00596939e7cb27af821a3119d60e55fd075ab1838e",
            },
            {
                "value": 214500,
                "fct_address": "330fd717584445ac866dc2facd8b856e63bdb8b15b5ed46c0b053b2c6c5c5c3f",
            }
        ]
        expected_outputs = [
            {
        ...
        for n, rcd in enumerate(tx.rcds):
            assert rcd.get("fct_public_key").hex() == expected_rcds[n].get("fct_public_key")
